...
-  Python 3.8+
-  pip installé
- 7-Zip installé et ajouté au PATH système (Windows uniquement) : [Site web](https://www.7-zip.org/)
...
3. **Commit** les changements (git commit -m 'Ajout d’une super fonctionnalité')
